...
const PATHS: Record<string, string> = {
  ...
  // Направления обучения — рисуем сами: системные эмодзи выглядят
  // по-разному в каждой ОС и рядом с линейными иконками смотрятся чужеродно.
  'f-cs': 'M9 9l-3 3 3 3M15 9l3 3-3 3M13.5 7l-3 10',
  'f-engineering': 'M12 2.5v2.6M12 18.9v2.6M4.9 4.9l1.8 1.8M17.3 17.3l1.8 1.8M2.5 12h2.6M18.9 12h2.6M4.9 19.1l1.8-1.8M17.3 6.7l1.8-1.8M12 8.4a3.6 3.6 0 100 7.2 3.6 3.6 0 000-7.2',
  'f-business': 'M4 20h16M7.5 20v-6M12 20V7M16.5 20v-9M14.5 4h4v4',
  'f-medicine': 'M2.5 12h3.2l1.8-5.5L11 18l2-6h6.5',
  'f-science': 'M9.5 3h5M10.8 3v6.3L5.9 18.2A2 2 0 007.7 21h8.6a2 2 0 001.8-2.8l-4.9-8.9V3M8.4 15h7.2',
  'f-social': 'M12 3a9 9 0 100 18 9 9 0 000-18M3.5 9.5h17M3.5 14.5h17M12 3c2.6 2.7 2.6 15.3 0 18M12 3C9.4 5.7 9.4 18.3 12 21',
  'f-design': 'M4 20l3.6-.8L18.9 7.9a2.6 2.6 0 10-3.7-3.7L3.9 15.5zM14.6 5.4l4 4',
...
/**
 * Код страны вместо эмодзи-флага: на Windows флаги не отрисовываются вовсе —
 * система показывает голые буквы, и рядом с линейными иконками это выглядело
 * как сломанная вёрстка. Бейдж рисуем сами, он одинаков во всех ОС.
 */
export function CountryTag({ code }: { code: string }) {
  return <span className="country-tag" aria-hidden>{code.toUpperCase()}</span>;
}
...
/** Логотип Google для кнопки входа — официальные цвета, иначе кнопку не узнают. */
